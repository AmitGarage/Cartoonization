...
class generator(nn.Module) :
    def __init__(self , channel=32, num_blocks=4 ) :
        ...
        self.conv6 = nn.ConvTranspose2d(channel*4, channel*2, kernel_size = [3 ,3], padding='same' ,stride=2)
        self.conv7 = nn.Conv2d(channel*2, channel*2, kernel_size = [3 ,3], padding='same' )
        self.conv8 = nn.ConvTranspose2d(channel*2, channel, kernel_size = [3 ,3], padding='same' ,stride=2)
